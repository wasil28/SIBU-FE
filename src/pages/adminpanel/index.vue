        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div v-for="task in backupTasks" :key="task.id" class="bg-white p-5 rounded-xl shadow-md">
            ...
            <button v-if="task.status === 'completed'"
              class="w-full text-center py-2 px-4 rounded-lg font-semibold bg-red-100 text-red-600 border border-red-500">
              Selesai
            </button>
            <button v-else-if="task.status === 'downloadable'"
              class="w-full text-center py-2 px-4 rounded-lg font-semibold bg-green-100 text-green-600 border border-green-500">
              Download
            </button>
            <button v-else-if="task.status === 'in_progress'"
              class="w-full text-center py-2 px-4 rounded-lg font-semibold bg-blue-100 text-blue-600 border border-blue-500">
              Backup
            </button>
            <button v-else
              class="w-full text-center py-2 px-4 rounded-lg font-semibold bg-gray-100 text-gray-600 border border-gray-400">
              Backup
            </button>
          </div>
        </div>
